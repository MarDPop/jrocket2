...
public class AtmosphereTabulated extends Atmosphere 
{
    ...
    public AtmosphereTabulated(double temperature, double groundPressure, 
    ...
    public AtmosphereTabulated(double[] heights, double[] values)
    {
